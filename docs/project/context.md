...
| 2026-09-14 | Not recorded | `laravel-security-sweep` skill, script, references and tests |
| 2026-09-14 | Claude Code · Opus 5 (1M context) (`claude-opus-5[1m]`) | `laravel-security-sweep` registration review; v1.25.0 release |
...
| | aiskills | TiTools |
|---|---|---|
| `skills/` | 11 general-purpose skills, including explicit-only `release` | 9 Titanium skills |
...
The trigger does not transfer either. `tiapp.xml` identifies a project where **all 9 of TiTools' skills apply**; this repo has no equivalent marker and its 11 skills cover disjoint domains — `stitch-showcase` and `vscode-extension-dev` are noise in a Laravel repo, `humaniza` only matters where there is Spanish text.
